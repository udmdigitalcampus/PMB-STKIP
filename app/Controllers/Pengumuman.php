...
class Pengumuman extends BaseController
{
	...
	public function index()
	{
		...
		$data = [
			...
			'profil' => $this->userModel->join('profil', 'profil.user_id = users.id')
				->join('status_mhs', 'status_mhs.profil_id = profil.id', 'LEFT')
				->find(user_id()),
			'title_meta' => view('panel/partials/title-meta', ['title' => 'Pengumuman']),
			'page_title' => view('panel/partials/page-title', ['title' => 'Pengumuman', 'li_1' => 'PMB STKIP NU INDRAMAYU', 'li_2' => 'Pengumuman'])
		];
