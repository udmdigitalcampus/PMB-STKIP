            ...
            <div class="dropdown d-none d-sm-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="gr">
                        <img src="<?= base_url(); ?>/assets/images/flags/germany.jpg" alt="user-image" class="me-1"
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="font-size-13 text-muted">
                                        ...
                                        <p class="mb-0"><i class="mdi mdi-clock-outline"></i>
                                            <span><?= lang('Files.1_hours_ago') ?></span></p>
                                    </div>
                                </div>
                            </div>
                        </a>
                        <a href="#!" class="text-reset notification-item">
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="font-size-13 text-muted">
                                        <p class="mb-1"><?= lang('Files.If_several_languages_coalesce_the_grammar') ?>
                                        </p>
                                        <p class="mb-0"><i class="mdi mdi-clock-outline"></i>
                                            <span><?= lang('Files.3_min_ago') ?></span></p>
                                    </div>
                                </div>
                            </div>
                        </a>
                        ...
                        <a href="#!" class="text-reset notification-item">
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="font-size-13 text-muted">
                                        <p class="mb-1">
                                            <?= lang('Files.As_a_skeptical_Cambridge_friend_of_mine_occidental') ?>.</p>
                                        <p class="mb-0"><i class="mdi mdi-clock-outline"></i>
                                            <span><?= lang('Files.1_hours_ago') ?></span></p>
                                    </div>
                                </div>
                    ...
                    <div class="p-2 border-top d-grid">
                        <a class="btn btn-sm btn-link font-size-14 text-center" href="javascript:void(0)">
                            ...
                            <span><?= lang('Files.View_More') ?>..</span>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item" href="auth-login"><i
                            class="mdi mdi-logout font-size-16 align-middle me-1"></i> <?= lang('Files.Logout') ?></a>
                </div>
            </div>
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle arrow-none" href="/" id="topnav-dashboard" role="button">
                            <i data-feather="home"></i><span
                                data-key="t-dashboards"><?= lang('Files.Dashboard') ?></span>
                        </a>
                    </li>
                                                ...
                                                <div class="col-lg-5">
                                                    <div>
                                                        <a href="ui-alerts" class="dropdown-item"
                                                            data-key="t-alerts"><?= lang('Files.Alerts') ?></a>
                                                        <a href="ui-buttons" class="dropdown-item"
                                                            data-key="t-buttons"><?= lang('Files.Buttons') ?></a>
                                                        <a href="ui-cards" class="dropdown-item"
                                                            data-key="t-cards"><?= lang('Files.Cards') ?></a>
                                                        <a href="ui-carousel" class="dropdown-item"
                                                            data-key="t-carousel"><?= lang('Files.Carousel') ?></a>
                                                        <a href="ui-dropdowns" class="dropdown-item"
                                                            data-key="t-dropdowns"><?= lang('Files.Dropdowns') ?></a>
                                                        <a href="ui-grid" class="dropdown-item"
                                                            data-key="t-grid"><?= lang('Files.Grid') ?></a>
                                                        <a href="ui-images" class="dropdown-item"
                                                            data-key="t-images"><?= lang('Files.Images') ?></a>
                                                        <a href="ui-modals" class="dropdown-item"
                                                            data-key="t-modals"><?= lang('Files.Modals') ?></a>
                                                    </div>
                                                </div>
                                                <div class="col-lg-5">
                                                    <div>
                                                        <a href="ui-offcanvas" class="dropdown-item"
                                                            data-key="t-offcanvas"><?= lang('Files.Offcanvas') ?></a>
                                                        <a href="ui-progressbars" class="dropdown-item"
                                                            data-key="t-progress-bars"><?= lang('Files.Progress_Bars') ?></a>
                                                        <a href="ui-tabs-accordions" class="dropdown-item"
                                                            data-key="t-tabs-accordions"><?= lang('Files.Tabs_n_Accordions') ?></a>
                                                        <a href="ui-typography" class="dropdown-item"
                                                            data-key="t-typography"><?= lang('Files.Typography') ?></a>
                                                        <a href="ui-video" class="dropdown-item"
                                                            data-key="t-video"><?= lang('Files.Video') ?></a>
                                                        <a href="ui-general" class="dropdown-item"
                                                            data-key="t-general"><?= lang('Files.General') ?></a>
                                                        <a href="ui-colors" class="dropdown-item"
                                                            data-key="t-colors"><?= lang('Files.Colors') ?></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <div>
                                                <a href="extended-lightbox" class="dropdown-item"
                                                    data-key="t-lightbox"><?= lang('Files.Lightbox') ?></a>
                                                <a href="extended-rangeslider" class="dropdown-item"
                                                    data-key="t-range-slider"><?= lang('Files.Range_Slider') ?></a>
                                                <a href="extended-sweet-alert" class="dropdown-item"
                                                    data-key="t-sweet-alert"><?= lang('Files.SweetAlert_2') ?></a>
                                                <a href="extended-session-timeout" class="dropdown-item"
                                                    data-key="t-session-timeout"><?= lang('Files.Session_Timeout') ?></a>
                                                <a href="extended-rating" class="dropdown-item"
                                                    data-key="t-rating"><?= lang('Files.Rating') ?></a>
                                                <a href="extended-notifications" class="dropdown-item"
                                                    data-key="t-notifications"><?= lang('Files.Notifications') ?></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-pages">
                            ...
                            <a href="apps-calendar" class="dropdown-item"
                                data-key="t-calendar"><?= lang('Files.Calendar') ?></a>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-email">
                                    <a href="apps-email-inbox" class="dropdown-item"
                                        data-key="t-inbox"><?= lang('Files.Inbox') ?></a>
                                    <a href="apps-email-read" class="dropdown-item"
                                        data-key="t-read-email"><?= lang('Files.Read_Email') ?></a>
                                </div>
                            </div>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-invoice">
                                    <a href="apps-invoices-list" class="dropdown-item"
                                        data-key="t-invoice-list"><?= lang('Files.Invoice_List') ?></a>
                                    <a href="apps-invoices-detail" class="dropdown-item"
                                        data-key="t-invoice-detail"><?= lang('Files.Invoice_Detail') ?></a>
                                </div>
                            </div>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-contact">
                                    <a href="apps-contacts-grid" class="dropdown-item"
                                        data-key="t-user-grid"><?= lang('Files.User_Grid') ?></a>
                                    <a href="apps-contacts-list" class="dropdown-item"
                                        data-key="t-user-list"><?= lang('Files.User_List') ?></a>
                                    <a href="apps-contacts-profile" class="dropdown-item"
                                        data-key="t-profile"><?= lang('Files.Profile') ?></a>
                                </div>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-components" role="button">
                            <i data-feather="box"></i><span
                                data-key="t-components"><?= lang('Files.Components') ?></span>
                            <div class="arrow-down"></div>
                        </a>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-form">
                                    <a href="form-elements" class="dropdown-item"
                                        data-key="t-form-elements"><?= lang('Files.Basic_Elements') ?></a>
                                    <a href="form-validation" class="dropdown-item"
                                        data-key="t-form-validation"><?= lang('Files.Validation') ?></a>
                                    <a href="form-advanced" class="dropdown-item"
                                        data-key="t-form-advanced"><?= lang('Files.Advanced_Plugins') ?></a>
                                    <a href="form-editors" class="dropdown-item"
                                        data-key="t-form-editors"><?= lang('Files.Editors') ?></a>
                                    <a href="form-uploads" class="dropdown-item"
                                        data-key="t-form-upload"><?= lang('Files.File_Upload') ?></a>
                                    <a href="form-wizard" class="dropdown-item"
                                        data-key="t-form-wizard"><?= lang('Files.Wizard') ?></a>
                                    <a href="form-mask" class="dropdown-item"
                                        data-key="t-form-mask"><?= lang('Files.Mask') ?></a>
                                </div>
                            </div>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-table">
                                    <a href="tables-basic" class="dropdown-item"
                                        data-key="t-basic-tables"><?= lang('Files.Bootstrap_Basic') ?></a>
                                    <a href="tables-datatable" class="dropdown-item"
                                        data-key="t-data-tables"><?= lang('Files.DataTables') ?></a>
                                    <a href="tables-responsive" class="dropdown-item"
                                        data-key="t-responsive-table"><?= lang('Files.Responsive') ?></a>
                                    <a href="tables-editable" class="dropdown-item"
                                        data-key="t-editable-table"><?= lang('Files.Editable') ?></a>
                                </div>
                            </div>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-charts">
                                    <a href="charts-apex" class="dropdown-item"
                                        data-key="t-apex-charts"><?= lang('Files.Apexcharts') ?></a>
                                    <a href="charts-echart" class="dropdown-item"
                                        data-key="t-e-charts"><?= lang('Files.Echarts') ?></a>
                                    <a href="charts-chartjs" class="dropdown-item"
                                        data-key="t-chartjs-charts"><?= lang('Files.Chartjs') ?></a>
                                    <a href="charts-knob" class="dropdown-item"
                                        data-key="t-knob-charts"><?= lang('Files.Jquery_Knob') ?></a>
                                    <a href="charts-sparkline" class="dropdown-item"
                                        data-key="t-sparkline-charts"><?= lang('Files.Sparkline') ?></a>
                                </div>
                            </div>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-icons">
                                    <a href="icons-boxicons" class="dropdown-item"
                                        data-key="t-boxicons"><?= lang('Files.Boxicons') ?></a>
                                    <a href="icons-materialdesign" class="dropdown-item"
                                        data-key="t-material-design"><?= lang('Files.Material_Design') ?></a>
                                    <a href="icons-dripicons" class="dropdown-item"
                                        data-key="t-dripicons"><?= lang('Files.Dripicons') ?></a>
                                    <a href="icons-fontawesome" class="dropdown-item"
                                        data-key="t-font-awesome"><?= lang('Files.Font_Awesome_5') ?></a>
                                </div>
                            </div>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-map">
                                    <a href="maps-google" class="dropdown-item"
                                        data-key="t-g-maps"><?= lang('Files.Google') ?></a>
                                    <a href="maps-vector" class="dropdown-item"
                                        data-key="t-v-maps"><?= lang('Files.Vector') ?></a>
                                    <a href="maps-leaflet" class="dropdown-item"
                                        data-key="t-l-maps"><?= lang('Files.Leaflet') ?></a>
                                </div>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-more" role="button">
                            <i data-feather="file-text"></i><span
                                data-key="t-extra-pages"><?= lang('Files.Extra_pages') ?></span>
                            <div class="arrow-down"></div>
                        </a>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-auth">
                                    <a href="auth-login" class="dropdown-item"
                                        data-key="t-login"><?= lang('Files.Login') ?></a>
                                    <a href="auth-register" class="dropdown-item"
                                        data-key="t-register"><?= lang('Files.Register') ?></a>
                                    <a href="auth-recoverpw" class="dropdown-item"
                                        data-key="t-recover-password"><?= lang('Files.Recover_Password') ?></a>
                                    <a href="auth-lock-screen" class="dropdown-item"
                                        data-key="t-lock-screen"><?= lang('Files.Lock_Screen') ?></a>
                                    <a href="auth-confirm-mail" class="dropdown-item"
                                        data-key="t-confirm-mail"><?= lang('Files.Confirm_Mail') ?></a>
                                    <a href="auth-email-verification" class="dropdown-item"
                                        data-key="t-email-verification"><?= lang('Files.Email_Verification') ?></a>
                                    <a href="auth-two-step-verification" class="dropdown-item"
                                        data-key="t-two-step-verification"><?= lang('Files.Two_Step_Verification') ?></a>
                                </div>
                            </div>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-utility">
                                    <a href="pages-starter" class="dropdown-item"
                                        data-key="t-starter-page"><?= lang('Files.Starter_Page') ?></a>
                                    <a href="pages-maintenance" class="dropdown-item"
                                        data-key="t-maintenance"><?= lang('Files.Maintenance') ?></a>
                                    <a href="pages-comingsoon" class="dropdown-item"
                                        data-key="t-coming-soon"><?= lang('Files.Coming_Soon') ?></a>
                                    <a href="pages-timeline" class="dropdown-item"
                                        data-key="t-timeline"><?= lang('Files.Timeline') ?></a>
                                    <a href="pages-faqs" class="dropdown-item"
                                        data-key="t-faqs"><?= lang('Files.FAQs') ?></a>
                                    <a href="pages-pricing" class="dropdown-item"
                                        data-key="t-pricing"><?= lang('Files.Pricing') ?></a>
                                    <a href="pages-404" class="dropdown-item"
                                        data-key="t-error-404"><?= lang('Files.Error_404') ?></a>
                                    <a href="pages-500" class="dropdown-item"
                                        data-key="t-error-500"><?= lang('Files.Error_500') ?></a>
                                </div>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle arrow-none" href="layouts-horizontal" role="button">
                            <i data-feather="layout"></i><span
                                data-key="t-horizontal"><?= lang('Files.Horizontal') ?></span>
                        </a>
                    </li>
